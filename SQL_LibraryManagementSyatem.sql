...
(
	...
	FOREIGN KEY (branch_id) REFERENCES  branch(branch_id) --FK
);
...
INSERT INTO Members(member_id, member_name, member_address, reg_date) 
VALUES
('C115', 'Ram', '156 Main St', '2026-04-15'),
('C116', 'Sham', '143 Elm St', '2026-02-20');
...
CREATE TABLE Branch_Performance_Reports
AS
SELECT
	b.branch_id,
	b.manager_id,
...
SELECT * FROM Branch_Performance_Reports;
